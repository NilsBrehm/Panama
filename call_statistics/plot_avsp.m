function plot_avsp(active, passive, similarity1, similarity2, matched)
...
for i = 1:noPulses
    for k = 1:noPulses
        ...
        if matched == 1
            ...
            text(-0.8, 0.2, ['r = ', num2str(round(similarity1(i,k),2))], 'color', textcolor1) % plot raw correlation
            text(-0.8, 0.0, ['ed = ', num2str(round(similarity2(i,k),2))], 'color', textcolor2) % plot raw correlation
        else

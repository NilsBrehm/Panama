...
fs = samplingrate;
audio_path = '/media/brehm/Data/MasterMoth/stimuli/callseries/moths/';
...
fig = figure('Visible', displayfigs);
set(fig, 'Color', 'white', 'Units', 'centimeters', 'position', pos_fig)
plot(t(1:end-tail), call_stim(1:end-tail),'color', 'black')
% xlim([0, tt(end)*1000])
xlabel('Time [s]')
ylabel('Amplitude')
box off
